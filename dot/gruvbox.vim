...
let s:gb.dark0_hard  = ['#161717', 234]     " 29-32-33
let s:gb.dark0       = ['#232629', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#232629', 236]     " 50-48-47
let s:gb.dark1       = ['#31363b', 237]     " 60-56-54
let s:gb.dark2       = ['#383D43', 239]     " 80-73-69
let s:gb.dark3       = ['#3C4248', 241]     " 102-92-84
let s:gb.dark4       = ['#4A5259', 243]     " 124-111-100
let s:gb.dark4_256   = ['#4A5259', 243]     " 124-111-100

let s:gb.gray_245    = ['#7f8c8d', 245]     " 146-131-116
let s:gb.gray_244    = ['#7f8c8d', 244]     " 146-131-116

let s:gb.light0_hard = ['#f9f5d7', 230]     " 249-245-215
let s:gb.light0      = ['#fbf1c7', 229]     " 253-244-193
let s:gb.light0_soft = ['#f2e5bc', 228]     " 242-229-188
let s:gb.light1      = ['#eff0f1', 223]     " 235-219-178
let s:gb.light2      = ['#d5c4a1', 250]     " 213-196-161
let s:gb.light3      = ['#bdae93', 248]     " 189-174-147
let s:gb.light4      = ['#2980b9', 246]     " 168-153-132
let s:gb.light4_256  = ['#a89984', 246]     " 168-153-132

let s:gb.neutral_red     = ['#ed1515', 167]     " 251-73-52
let s:gb.neutral_green   = ['#1abc9c', 142]     " 184-187-38
let s:gb.neutral_yellow  = ['#ffde35', 214]     " 250-189-47
let s:gb.neutral_blue    = ['#2f98d9', 109]     " 131-165-152
let s:gb.neutral_purple  = ['#9b59b6', 175]     " 211-134-155
let s:gb.neutral_aqua    = ['#43c1ff', 108]     " 142-192-124
let s:gb.neutral_orange  = ['#f67400', 208]     " 254-128-25

let s:gb.bright_red    = ['#da4453', 124]     " 204-36-29
let s:gb.bright_green  = ['#27ae60', 106]     " 152-151-26
let s:gb.bright_yellow = ['#fdbc4b', 172]     " 215-153-33
let s:gb.bright_blue   = ['#2980b9', 66]      " 69-133-136
let s:gb.bright_purple = ['#60459F', 132]     " 177-98-134
let s:gb.bright_aqua   = ['#3daee9', 72]      " 104-157-106
let s:gb.bright_orange = ['#f67400', 166]     " 214-93-14

let s:gb.faded_red      = ['#783228', 88]      " 157-0-6
let s:gb.faded_green    = ['#17a262', 100]     " 121-116-14
let s:gb.faded_yellow   = ['#b98936', 136]     " 181-118-20
let s:gb.faded_blue     = ['#1b668f', 24]      " 7-102-120
let s:gb.faded_purple   = ['#614a73', 96]      " 143-63-113
let s:gb.faded_aqua     = ['#256a8d', 66]      " 66-123-88
let s:gb.faded_orange   = ['#b65619', 130]     " 175-58-3
...
if version >= 703
  ...
  call s:HL('CursorLineNr', s:aqua, s:bg1)
endif
...
if has("spell")
  ...
  call s:HL('SpellLocal', s:none, s:none, s:undercurl, s:orange)
  " Rare word
  call s:HL('SpellRare',  s:none, s:none, s:undercurl, s:yellow)
endif
